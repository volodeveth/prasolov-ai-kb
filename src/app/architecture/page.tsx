...
const WHY_CARDS = [
  {
    ...
    body: "Векторний пошук (семантика) і BM25 (лексика) працюють паралельно, а їхні результати об'єднує Reciprocal Rank Fusion — жоден релевантний документ не губиться через дослівний збіг чи, навпаки, перефразування.",
  },
  {
