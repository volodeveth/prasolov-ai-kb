...
export function RoleSwitcher() {
  ...
  return (
    <div
      ...
      className="hidden items-center gap-0.5 rounded-lg bg-navy-800 p-0.5 sm:flex"
    >
      {ROLE_ORDER.map((r) => {
        const active = r === role;
        return (
          <button
            ...
            aria-checked={active}
            onClick={() => setRole(r)}
            className={`rounded-md px-2.5 py-1.5 font-body text-[13px] font-medium transition-colors duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brass ${
              active
